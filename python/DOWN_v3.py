...
tasks = (
    (DATA_3h, la, lo, param)
    for la in ndices_lat
    for lo in ndices_lon
)
...
# ==============================================================================
DOWN_out = os.path.join('..','output',f'{area}_DOWN_{product}_{time_reso}_{yy_s}_{yy_e}_npix_{param['npix']}_thr_{param['thresh']}_acf_{param['acf']}_{param['opt_method']}_{param['corr_method']}_inside.nc')
